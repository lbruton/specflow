      ...
      <div className="bg-[var(--surface-panel)] rounded-lg border border-[var(--border-default)] p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[var(--text-secondary)]">{t('projectDescription')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[var(--surface-panel)] border border-[var(--border-default)] rounded-lg p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="text-sm font-medium text-[var(--text-secondary)]">
              {t('stats.specifications.title')}
            </div>
          </div>
          <div className="text-2xl font-semibold text-[var(--text-primary)] mb-1 font-mono tabular-nums">
            {totalSpecs}
          </div>
        ...
        <div className="bg-[var(--surface-panel)] border border-[var(--border-default)] rounded-lg p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="text-sm font-medium text-[var(--text-secondary)]">
              {t('stats.taskProgress.title')}
            </div>
          </div>
          <div className="flex items-baseline gap-2 mb-2">
            <div className="text-2xl font-semibold text-[var(--text-primary)] font-mono tabular-nums">
              {completedTasks}
            </div>
            <div className="text-lg text-[var(--text-secondary)] font-mono tabular-nums">
              / {totalTasks}
            </div>
          </div>
        ...
        <div className="bg-[var(--surface-panel)] border border-[var(--border-default)] rounded-lg p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="text-sm font-medium text-[var(--text-secondary)]">
              {t('stats.approvals.title')}
            </div>
          </div>
          <div
            className={`text-2xl font-semibold mb-1 font-mono tabular-nums ${approvals.length > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-[var(--text-primary)]'}`}
          >
            {approvals.length}
          </div>
